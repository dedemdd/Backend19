...
#Si no quisieramos utilizar nuestro marshmallow-sqlalchemy y hacer el serializer manualmente se hace lo siguiente
class ManualCategoriaSerializer(Schema):
    ...
    #load_only > solamente se usara para cuando queramos devolver la informacion pero no para leerla
